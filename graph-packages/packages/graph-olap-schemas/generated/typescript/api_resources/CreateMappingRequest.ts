...
/**
 * General description of the mapping
 */
export type Description = string | null;
/**
 * Node definitions (at least one required)
 *
 * @minItems 1
 */
export type NodeDefinitions = [NodeDefinition, ...NodeDefinition[]];
/**
...
/**
 * Delete after no snapshots created (ISO 8601 duration)
 */
