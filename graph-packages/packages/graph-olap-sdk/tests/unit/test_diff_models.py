...
class TestNodeDiff:
    ...
    def test_create_added_node(self):
        ...
        node_diff = NodeDiff.model_validate({
            "label": "Customer",
            "change_type": "added",
            "fields_changed": None,
            "from": None,
    ...
    def test_create_removed_node(self):
        ...
        node_diff = NodeDiff.model_validate({
            ...
            "change_type": "removed",
            "fields_changed": None,
            "from": {"label": "OldNode", "sql": "SELECT * FROM old"},
            "to": None,
        })
    ...
    def test_create_modified_node(self):
        ...
        node_diff = NodeDiff.model_validate({
            ...
            "from": {"sql": "SELECT id, name FROM customers", "properties": []},
...
class TestEdgeDiff:
    ...
    def test_create_added_edge(self):
        ...
        edge_diff = EdgeDiff.model_validate({
            "type": "PURCHASED",
            "change_type": "added",
            "fields_changed": None,
            "from": None,
    ...
    def test_create_removed_edge(self):
        ...
        edge_diff = EdgeDiff.model_validate({
            ...
            "change_type": "removed",
            "fields_changed": None,
            "from": {"type": "OLD_RELATIONSHIP", "from_node": "A", "to_node": "B"},
            "to": None,
        })
    ...
    def test_create_modified_edge(self):
        ...
        edge_diff = EdgeDiff.model_validate({
            ...
            "from": {"properties": [{"name": "amount", "type": "INT64"}]},
